...
exports.app.post("/", (0, cors_1.default)(), (req, res) =>
...
exports.app.get("/signup", (0, cors_1.default)(), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {})
);
exports.app.post("/signup", (0, cors_1.default)(), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { login, pwd } = req.body;
...
exports.app.post("/diceRoll", (0, cors_1.default)(), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      console.log(login);
      if (login) {
        const { messageToUser, dices } = yield (0, diceRoller_1.rollerHandler)(
          login
        );
